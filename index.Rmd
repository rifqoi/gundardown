...
university-logo: templates/logogundar.png
...
pernyataan-originalitas: |
  `r paste(readLines("front-and-back-matter/_pernyataan-originalitas.Rmd"), collapse = "\n  ")`
  
lembar-pengesahan: |
  `r paste(readLines("front-and-back-matter/_lembar-pengesahan.Rmd"), collapse = "\n  ")`
  
kata-pengantar: |
  `r paste(readLines("front-and-back-matter/_kata-pengantar.Rmd"), collapse = "\n  ")`
  
abstract-heading: "ABSTRAK"
abstract: |
