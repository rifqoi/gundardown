...
\fancypagestyle{empty}{\fancyhf{}\fancyfoot[C]{\emph{\thepage}}} %chapter pages
...
\kota{Jakarta}
\pembimbing{Kemal Ade}
\fakultas{Fakultas Teknologi Industri}
\tahun{2022}
\judul{Prediksi Persija Menang Lawan MU}
...
% Change chapters number to roman
...
%
\def\crest{{\includegraphics[width=5cm]{templates/logogundar.png}}}
\renewcommand{\university}{Universitas Gunadarma}
...
\addcontentsline{toc}{chapter}{COVER HALAMAN}
\maketitle

%%%%% PERNYATAAN ORIGINALITAS
\begin{pernyataan-originalitas}
...
\renewcommand{\abstracttitle}{ABSTRAK}
\begin{abstract}
...
\renewcommand{\listfigurename}{DAFTAR GAMBAR} % uppercase title
\listoffigures
	\mtcaddchapter
  	% \mtcaddchapter is needed when adding a non-chapter (but chapter-like) entity to avoid confusing minitoc

% Uncomment to generate a list of tables:
\renewcommand{\listtablename}{DAFTAR TABEL} % uppercase title
\listoftables
  \mtcaddchapter
...
\FunctionTok{use\_python}\NormalTok{(}\StringTok{\textquotesingle{}/home/rifqoi/.conda/envs/data{-}exercises/bin/python3\textquotesingle{}}\NormalTok{)}
\FunctionTok{use\_condaenv}\NormalTok{(}\StringTok{\textquotesingle{}data{-}exercises\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{kable}\NormalTok{(py}\SpecialCharTok{$}\NormalTok{df1, }\AttributeTok{caption =} \StringTok{"Python Table"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{table}

\caption{\label{tab:python-table}Python Table}
\centering
...
Table \ref{tab:python-table} Bruh moment
